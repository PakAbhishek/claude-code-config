...
// File locations
const TOKEN_FILE = path.join(process.env.USERPROFILE || process.env.HOME, '.claude', 'hooks', '.edit_token.json');
const USAGE_LOG = path.join(process.env.USERPROFILE || process.env.HOME, '.claude', 'hooks', '.agent_usage_log.json');
