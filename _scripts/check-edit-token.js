 ...
 *
 * ENFORCEMENT CHAIN:
 *   Agent Completion → Token Generated → Edit/Write Allowed
 *
...
async function main() {
    try {
        ...
        if (testGate.blocked) {
            console.log('');
            console.log('╔══════════════════════════════════════════════════════════════╗');
            console.log('║      🧪 EDIT BLOCKED - TESTING REQUIRED 🧪                   ║');
            console.log('╚══════════════════════════════════════════════════════════════╝');
            console.log('');
            console.log(`❌ Reason: ${testGate.reason}`);
            console.log(`💡 Hint: ${testGate.hint}`);
            console.log('');
            console.log('┌─────────────────────────────────────────────────────────────┐');
            console.log('│                    TESTING GATE ACTIVE                       │');
            console.log('├─────────────────────────────────────────────────────────────┤');
            console.log('│                                                             │');
            console.log(`│  You have made ${testGate.editCount} edits without running tests.        │`);
            console.log('│  This increases the risk of introducing bugs.              │');
            console.log('│                                                             │');
            console.log('│  To continue editing, run:                                  │');
            console.log('│  • qa-test-engineer agent - To test your changes           │');
            console.log('│                                                             │');
            console.log('│  This resets the edit counter and reopens the gate.        │');
            console.log('│                                                             │');
            console.log('└─────────────────────────────────────────────────────────────┘');
            console.log('');
            process.exit(1);
        ...
        if (!result.valid) {
            console.log('');
            console.log('╔══════════════════════════════════════════════════════════════╗');
            console.log('║       🚫 EDIT/WRITE BLOCKED - NO AGENT PERMISSION 🚫         ║');
            console.log('╚══════════════════════════════════════════════════════════════╝');
            console.log('');
            ...
            console.log('');
            console.log('┌─────────────────────────────────────────────────────────────┐');
            console.log('│              AGENT-ENFORCED DEVELOPMENT PROTOCOL            │');
            console.log('├─────────────────────────────────────────────────────────────┤');
            console.log('│                                                             │');
            console.log('│  Before editing code, you MUST run one of these agents:    │');
            console.log('│                                                             │');
            console.log('│  • Explore agent - To understand the codebase              │');
            console.log('│  • Plan agent    - To design the implementation            │');
            console.log('│                                                             │');
            console.log('│  These agents will:                                        │');
            console.log('│  1. Research the relevant code                             │');
            console.log('│  2. Trace the execution flow                               │');
            console.log('│  3. Generate an edit token upon completion                 │');
            console.log('│                                                             │');
            console.log('│  There is NO manual way to get edit permission.            │');
            console.log('│  This ensures you understand before you change.            │');
            console.log('│                                                             │');
            console.log('└─────────────────────────────────────────────────────────────┘');
            console.log('');
        ...
        console.log('');
        console.log('✅ Edit permission validated and consumed');
        console.log(`   🤖 Granted by: ${result.token.grantedBy} agent`);
        console.log(`   📝 Task: ${result.token.taskDescription || 'N/A'}`);
        console.log(`   🔑 Token: ${result.token.id}`);
        console.log(`   📊 Edits since last test: ${state.editsSinceTest}/${MAX_EDITS_BEFORE_TEST}`);

        // Show warnings if needed
        if (testGate.warning) {
            console.log('');
            console.log(`   ⚠️  ${testGate.warning}`);
            console.log(`   💡 ${testGate.hint}`);
        }
